...
########################################################################################
# Author:       d4rk-d4nph3
# Description:  Forked from https://github.com/tokyoneon/Chimera
# Version:      0.1
# Modified at:  2021/08/04
# Note:         All credits go to the original coder
#				Chimera needs newer bash than v3 which is still the default for MacOS
########################################################################################
...
# Chimera requires GNU sed and not the FreeBSD sed that comes in MacOS
# brew install gnu-sed
alias sed="gsed"

# MacOS tr works slightly different from GNU
# Prefixing tr with LC_ALL=C will change the local character set to the C standard
# and not the UTF-8 encoded text that the MacOS tr expects by default
